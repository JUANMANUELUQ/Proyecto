...
public class Persistencia {
	 ...
	 * @return Datos obtenidos
	 */
	public static Concesionario realizarCarga(String ruta) 
	{  
		Concesionario  p=null;
		Concesionario datosObtenidos=null;
		File fOrig;
		fOrig = new File(ruta);
		if(fOrig.exists ( ))
		{
			p= (Concesionario) Persistencia.deserialize(ruta) ;
			datosObtenidos=p;
		}
